  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <svg viewBox="0 0 120 70" width="160" height="100">
        <path d="M10,65 A50,50 0 0,1 110,65" fill="none" stroke="currentColor" strokeOpacity={0.15} strokeWidth="10" strokeLinecap="round" />
        ...
        <g transform={`rotate(${angle}, 60, 65)`}>
          <line x1="60" y1="65" x2="60" y2="22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
        </g>
        <circle cx="60" cy="65" r="4" fill="currentColor" />
        <text x="60" y="58" textAnchor="middle" fontSize="11" fontWeight="bold" fill={color}>{pct}%</text>
      </svg>
      <span className="text-xs text-muted-foreground">Crisis Probability</span>
    </div>
  );
}
